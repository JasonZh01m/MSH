...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<form id="testForm" action="createEmpAction" method="post">
			<input value="CreateEmp" name="operationFlag" type="hidden">
			<div class="row clearfix">
						...
						<div class="col-md-6 column" style="width: 45%;">
							...
							<div id="profile-form">
								<div class="input-group input-group-sm editemp_form editemp_form0">
								  ...
								  <input id="eeip_chinesename" type="text" class="form-control red-tooltip" name="eeip_chinesename" required placeholder="Chinese Name">
								</div>
								<div class="input-group input-group-sm editemp_form editemp_form0">
								  <span class="input-group-addon">English Name:</span>
								  <input id="eeip_englishname" type="text" class="form-control red-tooltip" name="eeip_englishname" placeholder="English Name" >
								</div>
								<div class="input-group input-group-sm editemp_form editemp_form2">
								  <span class="input-group-addon" >Login ID:</span>
								  <input id="eeip_loginid" type="text" class="form-control red-tooltip" name="eeip_loginid" placeholder="Login ID">
								</div>
								<!-- <div class="input-group input-group-sm editemp_form editemp_form2">
						...
						<div class="col-md-6 column" style="width: 55%;">
							...
							<div id="profile-form">
								...
								<div class="input-group input-group-sm editemp_form editemp_form1">
								  ...
								  <input id="eeip_officephone" type="text" class="form-control red-tooltip" name="eeip_officephone" placeholder="Office Phone" >
								</div>
								<div class="input-group input-group-sm editemp_form editemp_form1">
								  ...
								  Skype:</span>
								  <input id="eeip_skype" type="text" class="form-control red-tooltip" name="eeip_skype" placeholder="Skype" >
								</div>
								<div class="input-group input-group-sm editemp_form editemp_form1">
								  <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>&nbsp;Email:</span>
								  <input id="eeip_email" type="text" class="form-control red-tooltip" name="eeip_email" placeholder="Email" >
								</div>
								...
								<div class="form-group input-group-sm">
									 ...
									 <textarea id="eeip_address" name="eeip_address" class="form-control" rows="2" cols="44" style="width: 291px; height: 60px; resize: none;"  placeholder="Input Address"></textarea>
								</div>
								...
								<select id="eeip_positiontitle" name="eeip_positiontitle" class="selectpicker" data-live-search="true">
								   <s:iterator var="positiontitleItor" value="#session.positiontitleList">
								   		...
								   		><s:property value="#positiontitleItor.positionTitleName" />  (<s:property value="#positiontitleItor.positionTitleDesc"/>)</option>
								   </s:iterator>
								 </select>
								</div>
								...
								<select id="eeip_department" name="eeip_department" class="selectpicker" data-live-search="true">
								   <s:iterator var="departmentItor" value="#session.departmentList">
								   		<option value="<s:property value="#departmentItor.departId" />"><s:property value="#departmentItor.departName" />  (<s:property value="#departmentItor.departDesc" />)
								   		</option>
								   </s:iterator>
								 </select>
								</div>
								...
								<select id="eeip_linemanager" name="eeip_linemanager" class="selectpicker" data-live-search="true">
								    <s:iterator var="lmItor" value="#session.loginviewList" status="st">
								   		<option 
								...
								<select id="eeip_systemrole" name="eeip_systemrole" class="selectpicker" data-live-search="true">
								   <s:iterator var="roleItor" value="#session.roleList">
								   		...
								   		><s:property value="#roleItor.sysRoleName" />  (<s:property value="#roleItor.sysRoleDesc" />)
								   		</option>
								   </s:iterator>
								 </select>
								</div>
					...
					<div class="col-md-6 column">
						...
						<div id="profile-form">
								<div class="input-group input-group-sm editemp_form">
								  ...
								  <input id="eeip_basesalary" name="eeip_basesalary" type="text" class="form-control red-tooltip" placeholder="Base Salary" >
								</div>
								...
								<div class="input-group input-group-sm editemp_form">
								  ...
								  <input id="eeip_socialinsurance" name="eeip_socialinsurance" type="text" class="form-control red-tooltip" placeholder="Social Insurance Base">
								</div>
								...
								<select id="eeip_mbo" name="eeip_mbo" class="selectpicker" data-live-search="true">
								    <s:iterator var="mboItor" value="#session.mboList">
								   		...
								   		><s:property value="#mboItor.mboRate" />%  (<s:property value="#mboItor.mboDesc" />)</option>
								   </s:iterator>
								 </select>
								</div>
								...
								<select id="eeip_costcenter" name="eeip_costcenter" class="selectpicker" data-live-search="true">
								    <s:iterator var="costcItor" value="#session.costcenterList">
								   		...
								   		><s:property value="#costcItor.costCenterName" />  (<s:property value="#costcItor.costCenterDesc" />)</option>
								   </s:iterator>
								 </select>
								</div>
							...
							<div  style="margin-bottom: 30px;">
								...
								<div class="col-md-6 column" style="padding: 0px;">
							      ...
							      <span class="input-group-addon" style=" background-color: white;">
							        <input id="eeip_withprobation" name="eeip_withprobation" type="checkbox" checked="checked">
							      </span>
								...
								<div id="probation_alert_info" class="alert alert-info alert-dismissable" style="display: none;">
								...
								<select id="eeip_contracttype" name="eeip_contracttype" class="selectpicker" data-live-search="true">
								    <s:iterator var="contractItor" value="#session.contracttypeList">
								   		...
								   		><s:property value="#contractItor.contractTypeName" />
								   </s:iterator>
								 </select>
								</div>
								...
								<select id="eeip_emptype" name="eeip_emptype" class="selectpicker" data-live-search="true">
								    <s:iterator var="emptypeItor" value="#session.emptypeList">
								   		...
								   		><s:property value="#emptypeItor.empTypeName" />  (<s:property value="#emptypeItor.empTypeDesc" />)</option>
								   	</s:iterator>
								 </select>
								</div>
								...
								<div class="col-md-6 column" style="padding: 0px;">
							      ...
							      <span class="input-group-addon" style=" background-color: white;">
							        <input id="eeip_onjob" name="eeip_onjob" type="checkbox" >
							      </span>
							      <input type="text" class="form-control" style="display: none;">
							     </div>
							    </div>
				                ...
				                <div id="onjob_alert_info" class="alert alert-info alert-dismissable">
									<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									<h4>Alert!</h4>
			...
			<div class="page-footer" style="height: 80px;">
				<p style="float: right; margin-right: 100px; margin-top: 40px;"><a id="" href="index.jsp" type="button" class="btn btn-primary btn-sm" role="button" style="margin-right: 10px;">Back to Home Page<a></a><input id="createBtn" type="button" class="btn btn-primary btn-sm" value="Save" role="button"/></p>
			</div>
		</div>
	</div>
</div>
