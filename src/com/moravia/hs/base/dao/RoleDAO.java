 ...
 * 
 * @see com.moravia.hs.base.entity.Role
...
public class RoleDAO extends HibernateDaoSupport {
	...
	// property constants
	public static final String SYS_ROLE_NAME = "sysRoleName";
	public static final String SYS_ROLE_DESC = "sysRoleDesc";
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) getHibernateTemplate().get(
					"com.moravia.hs.base.entity.Role", id);
			return instance;
		} catch (RuntimeException re) {
...
//					.createCriteria("com.moravia.hs.base.entity.Role")
...
//	}
//
//	public List<Role> findBySysRoleName(Object sysRoleName) {
//		return findByProperty(SYS_ROLE_NAME, sysRoleName);
//	}
//
//	public List<Role> findBySysRoleDesc(Object sysRoleDesc) {
//		return findByProperty(SYS_ROLE_DESC, sysRoleDesc);
//	}
//
	public List findAll() {
