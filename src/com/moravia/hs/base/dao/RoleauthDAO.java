...
import com.moravia.hs.base.entity.Roleauth;
 ...
 * 
 * @see com.moravia.hs.base.entity.Roleauth
 * @author MyEclipse Persistence Tools
 */

public class RoleauthDAO extends HibernateDaoSupport {
	...
	public Roleauth findById(java.lang.Integer id) {
		...
		try {
			Roleauth instance = (Roleauth) getHibernateTemplate().get(
					"com.moravia.hs.base.entity.Roleauth", id);
			return instance;
		} catch (RuntimeException re) {
...
//		try {
//			List<Roleauth> results = (List<Roleauth>) getHibernateTemplate()
//					.createCriteria("com.moravia.hs.base.entity.Roleauth")
...
//			Query queryObject = session.createQuery(queryString);
	...
	public Roleauth merge(Roleauth detachedInstance) {
		...
		try {
			Roleauth result = (Roleauth) getHibernateTemplate().merge(detachedInstance);
