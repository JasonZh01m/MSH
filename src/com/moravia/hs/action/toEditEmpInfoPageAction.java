...
@Controller("toEditEmpInfoPageAction")
public class toEditEmpInfoPageAction extends BaseAction{
	...
	private String operationFlag_toeeip;
	
	public void setOperationFlag_toeeip(String operationFlag_toeeip) {
		this.operationFlag_toeeip = operationFlag_toeeip;
	}
	...
	public String execute() throws Exception {
		...
		/*Emp eip_emp = (Emp) session.get("eip_emp");
		
		if(eip_emp != null) {
			// System.out.println("eip_emp.getEmail(): " + eip_emp.getEmail());
			
		}*/
//		// System.out.println("operationFlag_toeeip: " + operationFlag_toeeip);
		/*if(operationFlag_toeeip.equals("editEmpInfo")) {*/
